		...
		<tbody>
			...
			<c:if test="${list != null}">
				...
				<tr>
					...
					<td>
						<fmt:formatNumber value="${dto.price_each}"/>원<br/>
						<fmt:formatNumber value="${dto.point}"/>포인트
					</td>
					<td>
						<fmt:formatNumber value="${dto.price_each*dto.qty_ordered}"/>원<br/>
						<fmt:formatNumber value="${dto.point*dto.qty_ordered}"/>포인트
					</td>
					
					<!-- 총액 합계 계산 -->
						<c:set var="TotPrice" value="${TotPrice + dto.price_each*dto.qty_ordered}"/>
						<c:set var="TotPoint" value="${TotPoint + dto.point*dto.qty_ordered}"/>
					</tr>
				</c:forEach>
			</c:if>
		</tbody>
