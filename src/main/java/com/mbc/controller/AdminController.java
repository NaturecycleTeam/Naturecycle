...
//		System.out.println(list.get(lastIndex).getPurchase_amount());
//		String today_purchase = list.get(lastIndex).getPurchase_amount();
//		application.setAttribute("today_purchase", today_purchase);
//		
...
//			String date = sd.format(dto.getOrder_month());
